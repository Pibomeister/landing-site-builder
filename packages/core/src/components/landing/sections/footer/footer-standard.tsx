...
export interface FooterStandardProps extends FooterStandardSection {
  className?: string;
}
...
export function FooterStandard({
  ...
  return (
    <footer className={`bg-muted/30 border-t border-border ${className}`}>
      {/* Top section */}
      <Container size={container || 'xl'} className="py-12 md:py-16">
          ...
          <div className="col-span-2 lg:col-span-2">
            ...
            >
              {logo.src ? (
                ...
                <span className="font-semibold text-foreground">{logo.text}</span>
              )}
            </a>

            {/* Tagline */}
            {tagline && <p className="mt-2 text-sm text-muted-foreground max-w-xs">{tagline}</p>}
      ...
      <div className="border-t border-border">
        <Container size={container || 'xl'} className="py-6">
